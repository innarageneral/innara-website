...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="pricing" className="py-24 md:py-32 bg-white px-6 lg:px-12 bg-gradient-to-l from-[#ECEFFC] to-[#FFFFFF]">
          ...
          <div className="grid md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-300">
                <li><a href="#features" className="hover:text-[var(--innara-surface)] transition">Features</a></li>
                <li><a href="#plans" className="hover:text-[var(--innara-surface)] transition">How it Works</a></li>
                <li><a href="#pricing" className="hover:text-[var(--innara-surface)] transition">Pricing</a></li>
              </ul>
            </div>
            <div>
