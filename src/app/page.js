...
export default function Home() {
  ...
  const plans = [
    {
      name: "Starter",
      icon: Heart,
      description: "Perfect for getting started with hormone-balanced nutrition",
      monthlyPrice: 9.99,
      annualPrice: 99.99,
      features: [
        "Basic meal plans for your cycle",
    ...
    },
    {
      name: "Nourish Pro",
      icon: Sparkles,
      description: "Complete hormone health optimization with AI guidance",
      monthlyPrice: 19.99,
      annualPrice: 199.99,
      features: [
    ...
    },
    {
      name: "Elite Care",
      icon: Crown,
      description: "Premium experience with expert consultations",
      monthlyPrice: 39.99,
      annualPrice: 399.99,
      features: [
        "Everything in Nourish Pro",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="pricing" className="relative py-24 md:py-32 bg-white px-6 lg:px-12 py-20 bg-gradient-to-l from-[#ECEFFC] to-[#FFFFFF]">
        <div className="container mx-auto px-6">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[var(--innara-footer)] mb-4">
              Choose Your Hormone Health Journey
            </h2>
            <p className="text-lg text-[var(--innara-footer)]/70 max-w-2xl mx-auto">
              Start with a plan that fits your needs. Upgrade or downgrade anytime.
            </p>

            {/* Billing Toggle */}
            <div className="inline-flex items-center bg-white/60 backdrop-blur-md rounded-full p-1 mt-8 shadow-sm">
              <button
          ...
          <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
            {plans.map((plan) => {
              ...
              return (
                <div
                  key={plan.name}
                  className={`relative rounded-3xl border-2 p-10 bg-white shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 ${
                    plan.popular
                      ? "border-[var(--innara-primary)] scale-105"
                      : "border-transparent"
                  }`}
                >
                  {plan.popular && (
                  ...
                  <div className="text-center mb-6">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 bg-[var(--innara-primary)]/10 text-[var(--innara-primary)]">
                      <IconComponent className="w-8 h-8" />
                    </div>
                    <h3 className="text-2xl font-bold text-[var(--innara-footer)] mb-2">
                      {plan.name}
                    </h3>
                    <p className="text-sm text-[var(--innara-footer)]/70">
                      {plan.description}
                    </p>
                  </div>
                  ...
                  <div className="text-center mb-6">
                    <div className="flex items-baseline justify-center gap-1">
                      <span className="text-4xl font-bold text-[var(--innara-footer)]">
                        ${price}
                      </span>
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-[var(--innara-footer)]">
                          {feature}
                        </span>
                      </li>
                    ))}
                  ...
                  {plan.name === "Elite Care" && (
                    <p className="text-xs text-center text-[var(--innara-footer)]/70 mt-3">
          ...
          <div className="text-center mt-16">
            <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-[var(--innara-footer)]/70">
              <div className="flex items-center gap-2">
                <Check className="w-4 h-4 text-[var(--innara-primary)]" />
